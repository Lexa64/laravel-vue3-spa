...
class UtilityTariffController extends Controller
{
    ...
    public function store(StoreUtilityTariffRequest $request)
    {
        $utilityTariff = UtilityTariff::create([
            ...
            'ut_1_4_economically_justified' => $request->ut_1_4_economically_justified,
            'ut_2_1_economically_justified' => $request->ut_2_1_economically_justified,
            'ut_2_2_economically_justified' => $request->ut_2_2_economically_justified,
            ...
            'ut_1_4_state_subsidized' => $request->ut_1_4_state_subsidized,
            'ut_2_1_state_subsidized' => $request->ut_2_1_state_subsidized,
            'ut_2_2_state_subsidized' => $request->ut_2_2_state_subsidized,
