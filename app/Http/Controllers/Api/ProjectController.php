...
class ProjectController extends Controller
{
    ...
    public function calculateLifecycle(Request $request)
    {
        ...
        $data['resource_consumption']['1_2'] = $project->utilityCost->uc_1_2;
        $data['economically_justified']['1_2'] = round($project->utilityCost->uc_1_2 * $project->tariff->ut_1_2_economically_justified, 2);
        $data['state_subsidized']['1_2'] = round($project->utilityCost->uc_1_2 * $project->tariff->ut_1_2_state_subsidized, 2);

        $data['resource_consumption']['1_3'] = $project->utilityCost->uc_1_3;
        $data['economically_justified']['1_3'] = round($project->utilityCost->uc_1_3 * $project->tariff->ut_1_3_economically_justified, 2);
        $data['state_subsidized']['1_3'] = round($project->utilityCost->uc_1_3 * $project->tariff->ut_1_3_state_subsidized, 2);

        $data['resource_consumption']['1_4'] = $project->utilityCost->uc_1_4;
        $data['economically_justified']['1_4'] = round($project->utilityCost->uc_1_4 * $project->tariff->ut_1_4_economically_justified, 2);
        $data['state_subsidized']['1_4'] = round($project->utilityCost->uc_1_4 * $project->tariff->ut_1_4_state_subsidized, 2);

        $data['resource_consumption']['2'] = $project->utilityCost->uc_2;
        $data['economically_justified']['2'] = round($project->utilityCost->uc_2 * $project->tariff->ut_2_economically_justified, 2);
        $data['state_subsidized']['2'] = round($project->utilityCost->uc_2 * $project->tariff->ut_2_state_subsidized, 2);

        $data['resource_consumption']['3'] = $project->utilityCost->uc_3;
        $data['economically_justified']['3'] = round($project->utilityCost->uc_3 * $project->tariff->ut_3_economically_justified, 2);
        $data['state_subsidized']['3'] = round($project->utilityCost->uc_3 * $project->tariff->ut_3_state_subsidized, 2);
