<template>
    ...
    <form class="" @submit.prevent="saveProject">
        <div class="container w-25">
            ...
            <div>
                <label for="name" class="">{{ $t('projects.year_construction') }}</label>
                <div class="mt-1">
            ...
            <div>
                <label for="name" class="">{{ $t('projects.year_renovation') }}</label>
                <div class="mt-1">
            ...
            <div>
                <label for="name" class="">{{ $t('projects.square_living') }}</label>
                <div class="mt-1">
            ...
            <div>
                <label for="name" class="">{{ $t('projects.square_auxiliary') }}</label>
                <div class="mt-1">
            ...
            <div>
                <label for="name" class="">{{ $t('projects.apartment_count') }}</label>
                <div class="mt-1">
            ...
            <div>
                <label for="name" class="">{{ $t('projects.residents_count') }}</label>
                <div class="mt-1">
